...
[test-image]: https://github.com/stdlib-js/datasets/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/datasets/actions/workflows/test.yml?query=branch:v0.3.0
